...
// commands to run in Command Line Mode
// run development: NODE_ENV=development webpack
// run production: NODE_ENV=production webpack
...
module.exports = {
	...
	plugins: [], // need for correct work of -> module.exports.plugins.push
